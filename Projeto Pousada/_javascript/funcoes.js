/* slide de imagens grande */
function slide1() {
    document.getElementById('foto').src = "imagens/frente1.jpg", "aqui";
...
function slide3() {
    document.getElementById('foto').src = "imagens/entrada.jpg";
    setTimeout("slide1()", 4000)
}
/* troca de imagens do cadeçalho e cor do body conforme a hora */
function carregar() {
...
//entrada das datas e opção de quarto 
function somar() {
